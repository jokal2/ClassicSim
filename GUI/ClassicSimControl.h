...
public:
    ...
    void setMainHand(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setOffHand(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setRanged(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setHead(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setNeck(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setShoulders(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setBack(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setChest(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setWrist(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setGloves(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setBelt(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setLegs(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setBoots(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setRing1(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setRing2(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setTrinket1(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setTrinket2(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setProjectile(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setRelic(const QString& slot_string, const int item_id, const uint affix_id = 0);
    void setQuiver(const QString& slot_string, const int item_id, const uint affix_id = 0);
